...
jest.mock('../../../src/hooks/useParticipantNetworkQualityLevel/useParticipantNetworkQualityLevel', () => () => 4);
jest.mock('../../../src/hooks/usePublications/usePublications');
jest.mock('../../../src/hooks/useIsTrackSwitchedOff/useIsTrackSwitchedOff');
jest.mock('../../../src/hooks/useTrack/useTrack');
